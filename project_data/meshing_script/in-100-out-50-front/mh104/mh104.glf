...
set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic C:/Users/JJD/Desktop/project_data/dat/mh104.dat
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end
unset _TMP(mode_1)
...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_DM(1)]]]
  $_TMP(mode_1) initialize -strict -type CAE C:/Users/JJD/Desktop/project_data/cas/in-100-out-50-front/mh104/mh104.cas
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
pw::Application save C:/Users/JJD/Desktop/project_data/cas/in-100-out-50-front/mh104/mh104.pw
pw::Application exit